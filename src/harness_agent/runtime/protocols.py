...
class SpawnedProcessStore(Protocol):
    ...
    async def delete(self, *, process_id: str, user_id: str) -> None:
        """Remove the record. Implementations that publish events may
        accept additional context (e.g. termination reason) as keyword
        arguments; the default signature is the minimum contract."""
        ...
