...
class HarnessApp:
    ...
    def _wire(self) -> None:
        ...
        self.bus.subscribe(AgentTurnRequested, self._send_telegram_writing)
        self.bus.subscribe(
            AgentTurnRequested,
    ...
    async def _send_telegram_writing(self, event: AgentTurnRequested) -> tuple:
        ...
        await self.telegram.send_writing_action(event)
        return ()
